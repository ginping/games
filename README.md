...
这个仓库不是单个小游戏仓库，而是一个“游戏宿主应用”示例：用一个统一入口承载多个可以独立访问、独立演进的浏览器游戏。当前已经完成首款可玩游戏 `1024`，并继续以它来验证三件事：
...
- [app/1024/page.tsx](app/1024/page.tsx)：`1024` 游戏页面
